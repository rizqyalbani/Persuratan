...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Apr 2020 pada 07.18
...
(42, '2020-04-07', '2020-04-08', '4555', 3, 'testing surat masuk disposisi', 12, 1, 1, 12, '2020-04-07 20:57:23');
...
CREATE TABLE `tbl_disposisi_keluar` (
  `id_disposisi_keluar` int(11) NOT NULL,
  `tanggal` date NOT NULL,
  `tanggal_penyelesaian` date NOT NULL,
  `no_agenda` varchar(11) NOT NULL,
  `id_jenis_disposisi` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `tbl_disposisi_keluar`
--

INSERT INTO `tbl_disposisi_keluar` (`id_disposisi_keluar`, `tanggal`, `tanggal_penyelesaian`, `no_agenda`, `id_jenis_disposisi`, `instruksi`, `id_user`, `id_status`, `id_jenis_surat`, `id_surat_keluar`, `postedTime`) VALUES
(10, '2020-04-07', '2020-04-08', '341231', 3, 'testing keluar', 12, 1, 1, 5, '2020-04-07 19:47:10'),
(15, '2020-04-07', '2020-04-08', '12345', 2, 'testing namba3', 12, 2, 1, 5, '2020-04-07 20:29:38'),
(16, '2020-04-04', '2020-04-05', '4555', 1, 'ini last test surat keluar', 12, 2, 1, 5, '2020-04-07 20:56:35');
...
ALTER TABLE `tbl_disposisi_keluar`
  ADD PRIMARY KEY (`id_disposisi_keluar`),
  ADD KEY `jenis_disposisi` (`id_jenis_disposisi`),
  ADD KEY `id_user` (`id_user`),
  ADD KEY `id_surat_masuk` (`id_surat_keluar`),
  ADD KEY `id_status` (`id_status`),
  ADD KEY `id_jenis_surat` (`id_jenis_surat`);
...
--
ALTER TABLE `tbl_disposisi`
  MODIFY `id_disposisi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT untuk tabel `tbl_disposisi_keluar`
--
ALTER TABLE `tbl_disposisi_keluar`
  MODIFY `id_disposisi_keluar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
-- Ketidakleluasaan untuk tabel `tbl_disposisi_keluar`
--
ALTER TABLE `tbl_disposisi_keluar`
  ADD CONSTRAINT `tbl_disposisi_keluar_ibfk_1` FOREIGN KEY (`id_jenis_disposisi`) REFERENCES `tbl_jenis_disposisi` (`id_jenis_disposisi`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_disposisi_keluar_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `tbl_user` (`id_user`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_disposisi_keluar_ibfk_3` FOREIGN KEY (`id_status`) REFERENCES `tbl_status` (`id_status`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_disposisi_keluar_ibfk_4` FOREIGN KEY (`id_jenis_surat`) REFERENCES `tbl_jenis_surat` (`id_jenis_surat`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_disposisi_keluar_ibfk_5` FOREIGN KEY (`id_surat_keluar`) REFERENCES `tbl_surat_keluar` (`id_surat_keluar`) ON UPDATE CASCADE;
