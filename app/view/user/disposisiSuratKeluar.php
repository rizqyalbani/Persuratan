    ...
    <ul>
        ...
        <li>Perihal : <?php echo $data['perihal'][$a]['perihal_surat_keluar'] ?></li>
        <li>Instruksi : <?php echo $user['instruksi']?></li>
        <li>jenis disposisi : <?=$data['jenis_disposisi'][$a]?></li>
        <li>Surat dari Instansi : <?php echo $data['suratAsal'][$a]['nama_instansi_surat_keluar'] ?></li>
    ...
    <?php
        // print_r($user['id_status']);
        // $id_status = [];
        // $id_status[] = $data['status'][$a]['status'];
        $a++
    ?>
    <?php endforeach ?>
